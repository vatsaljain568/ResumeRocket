          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              {isEditing ? (
                ...
                <h1 className="text-3xl font-bold text-white">{data.name || "Your Name"}</h1>
              )}
              ...
              {isEditing ? (
                ...
                <p className="text-xl text-white opacity-90">{data.title || "Your Title"}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center">
                ...
                {isEditing ? (
                  ...
                  <span className="text-gray-600">{data.email || "email@example.com"}</span>
                )}
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                {isEditing ? (
                  ...
                  <span className="text-gray-600">{data.phone || "(123) 456-7890"}</span>
                )}
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                {isEditing ? (
                  ...
                  <span className="text-gray-600">{data.location || "City, State"}</span>
                )}
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="mb-8">
            ...
            {isEditing ? (
              ...
              <p className="text-gray-600">{data.about || "No information provided."}</p>
            )}
          </div>
